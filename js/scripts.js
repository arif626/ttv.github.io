...
var cplayer = new Clappr.Player({
    source: 'http://td.chowdhury-shaheb.com/live/titastv/playlist.m3u8',
    poster: 'img/welcome.png',
    parentId: "#cplayer",
    height: "100%",
    width: "100%"
});
$('#mplayer').width($('#mplayerholder').width() - 15);
$('#mplayer').height($('#mplayerholder').width() * (9 / 16) - 10);
var mplayer = new MediaElementPlayer('mplayer', {
    success: function(mediaElement, originalNode) {
        console.log("Player initialised");
    }
});
mplayer.setSrc("http://td.chowdhury-shaheb.com/live/titastv/playlist.m3u8");

$(".playignitor, .thumbnail").click(function() {

    var urlholder = $(this);

    if (urlholder.data("myplayer") == "mplayer") {
        cplayer.stop();
        $('#mplayer').height($('#mplayerholder').width() * (9 / 16));
        $("#cplayerholder").css({
            "display": "none"
        });
        $("#mplayerholder").css({
        ...
        mplayer.setSrc(urlholder.data("source"));
        mplayer.play();
...
$(document).ready(function() {
    $('#cplayerholder, #mplayerholder, #mplayer').height($('#cplayerholder').width() * (9 / 16));
    $('#contact-list').height($('#cplayerholder').height() - 51);
});
